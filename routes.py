...
@app.route('/buyer/create-transaction', methods=['GET', 'POST'])
@login_required
def create_transaction():
    ...
    if form.validate_on_submit():
        ...
        flash('Transaction created successfully! Waiting for a seller to accept.', 'success')
        return redirect(url_for('buyer_dashboard'))
    return render_template('buyer/create_transaction.html', form=form)
